class CastlesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @castle.save
        format.html { redirect_to castle_url(@castle), notice: "Castle was successfully created." }
  ...
  def update
    respond_to do |format|
      if @castle.update(castle_params)
        format.html { redirect_to castle_url(@castle), notice: "Castle was successfully updated." }
  ...
  private
    ...
    def castle_params
      params.require(:castle).permit(:name, :players, :is_open)
    end
end
